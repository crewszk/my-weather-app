...
only using a handful of components that starts with a form that accepts either a zipcode or a State + City, though the zipcode takes priority. It will then search
